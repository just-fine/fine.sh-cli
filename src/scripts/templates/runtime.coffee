...
<head>
  ...
  <link rel=\"stylesheet\" href=\"//cdn.jsdelivr.net/npm/@fine.sh/themes@0.0.3/dist/plain.css\">
  <title>FINE_TITLE</title>
</head>
<script>window.fine_settings=FINE_INTERFACE</script>
<body>
<div id=\"app\"></div>
<script src=\"//cdn.jsdelivr.net/npm/@fine.sh/runtime@0.0.8/dist/run_time.js\" type=\"text/javascript\"></script>
</body>
</html>
"
